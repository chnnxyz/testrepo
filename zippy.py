...
wrestling_csv = os.path.join('Documents', 'WWE-Data-2016.csv')


# Define the function and have it accept the 'wrestler_data' as its sole parameter
def print_percentages(wrestler_data):
    '''
    Generates variables for totals, wins and losses
    calculates percentages
    prints if jobber or superstar according to loss percentage
    '''
